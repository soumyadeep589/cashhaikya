...
class Request(models.Model):
    ...
    opened_by = models.ForeignKey(CustomUser, on_delete=models.PROTECT, related_name='opened_requests')
    type = models.CharField(max_length=16, choices=Type.choices, default=Type.BANK)
    amount = models.DecimalField(max_digits=8, decimal_places=2)
    closed_to = models.ForeignKey(CustomUser, on_delete=models.PROTECT, null=True, blank=True, related_name='closed_requests')
